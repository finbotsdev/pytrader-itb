...
APCA_API_ENDPOINT = os.getenv('APCA_API_ENDPOINT')
APCA_API_KEY_ID = os.getenv('APCA_API_KEY_ID')
APCA_API_SECRET_KEY = os.getenv('APCA_API_SECRET_KEY')

# this block checks whether you have your keys written or not
if APCA_API_KEY_ID is "" or APCA_API_SECRET_KEY is "":
...
RAW_ASSETS = './assets.csv' # you should have this list at the same folder than everything
